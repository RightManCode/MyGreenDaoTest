package com.example.admin.mygreendaotest.dao;
...
public class UserDao extends AbstractDao<User, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Interests = new Property(3, String.class, "interests", false, "INTERESTS");
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // interests
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setInterests(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
